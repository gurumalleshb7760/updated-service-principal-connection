    ...
    <div class="container" style="margin-top:8%">
       ...
       function getSeatLayout(row, column, bookSeat,fare) {
           ...
           var init = function (reservedSeat, fareDetails) {
               ...
               //console.log(`reservedSeat${reservedSeat} fareDetails${fareDetails}`);

               var str = [], seatNo, className, totalAmount;
               totalAmount = fareDetails;

               console.log(`row ${settings.rows} column ${settings.cols}`);
               ...
               for (let i = 0; i < settings.rows; i++) {
                   for (let j = 0; j < settings.cols; j++) {
                       ...
                       //console.log(`reservedSeat:${reservedSeat} seatNo:${seatNo}`);
           ...
           $('.' + settings.seatCss).click(function () {
               if ($(this).hasClass(settings.selectedSeatCss)) {
                   ...
                   if (str.length > 10) {
                       ...
                       alert('You can not select more than ten seats per booking');
                   }
                   else {
