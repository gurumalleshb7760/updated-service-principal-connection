    ...
    <div class="container" style="margin-top:6%">
              ...
              <div id="ticket" runat="server" visible="false">
                ...
                <p style="text-align: left; font-size: 10pt">
                     Important:<br/>
                            <ul>
                            <li> The seat(s) booked are not transferable</li>
                            <li> Please arrive at the boarding point 30 minutes before departure.</li>
                            <li> This is an electronic ticket; no physical ticket will be issued.</li>
                            <li> Tickets are non-refundable</li>
                            </ul>
                            </p>  
                            <p style="text-align: left; font-size: 10pt">
  
                                                For any assistance, contact our customer service at 7760502818 (Guru) or onlinebusbookink@cloudteam.com.
                            </p>
                            <p style="text-align: center; font-style: italic; font-size: 20pt">
