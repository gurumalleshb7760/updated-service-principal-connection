<%@ Page Title="" Language="C#" MasterPageFile="~/BusBookingMaster.Master" AutoEventWireup="true" Debug="true" CodeBehind="UserRegistration.aspx.cs" Inherits="BusBookingProject.UserRegistration" %>
                ...
                <div class="panel-body">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                       ...
                       <div class="form-group">
                            ...
                            <asp:TextBox ID="txtMobileNo" runat="server" class="form-control input-sm floatlabel"></asp:TextBox>
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="txtMobileNo" Display="None" ID="rfVMobileNo"
                                    ValidationGroup="vgRegister" CssClass="text-danger" ErrorMessage="Mobile No is required."></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator runat="server" ControlToValidate="txtMobileNo" Display="None" ID="revMobileNo"
                                    ValidationGroup="vgRegister" CssClass="text-danger" ErrorMessage="Please enter a 10-digit mobile number."
                                    ValidationExpression="^\d{10}$"></asp:RegularExpressionValidator><br />
                            </div>
                    </div>
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                       ...
                       <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txtPassword" Display="None" ID="rfvPassword"
                                ValidationGroup="vgRegister" CssClass="text-danger" ErrorMessage="Password is required." /><br />
                        <asp:RegularExpressionValidator runat="server" ControlToValidate="txtPassword" Display="None"
                                ID="revPassword" ValidationGroup="vgRegister" CssClass="text-danger"
                                ErrorMessage="Password must be strong (e.g., at least 8 characters, with at least one uppercase letter, one lowercase letter, one digit, and one special character)."
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <asp:RegularExpressionValidator runat="server" ControlToValidate="txtEmailID" Display="None"
                                ...
                                ErrorMessage="Please enter a valid Gmail address." ValidationExpression="^[a-zA-Z0-9_.+-]+@[a-zA-Z]+\.com$"></asp:RegularExpressionValidator><br />
                        </div>
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        ...
                        <asp:RegularExpressionValidator runat="server" ControlToValidate="txtPincode" Display="None"
                            ...
                            ErrorMessage="Please enter a 6-digit pin code." ValidationExpression="^\d{6}$"></asp:RegularExpressionValidator><br />
                    </div>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            <asp:Button ID="Button1" runat="server" Text="Register" OnClick="btnSave_Click" class="btn btn-info " ValidationGroup="vgRegister"  CausesValidation="True" ViewStateMode="Inherit" />
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
